  ...
  return (
    <div className='w-screen bg-furriesGreen' style={{ height: '88vh', minHeight: '88vh' }}>
        ...
        <div className='flex h-full  items-center justify-between text-white'>
            {/* Text Section */}
        <div className='z-10 flex w-full flex-col gap-4 px-16 py-4 font-medium lg:w-1/2'>
            ...
            <button className='mt-8 w-full rounded-3xl bg-button-gradient p-3 font-light sm:w-2/6' style={{ fontFamily: "Urbanist"}}>Shop Now</button>
        </div>

        {/* Image Section */}
        <img src={HeroImage} alt='Hero Image' className='absolute right-0 top-2 z-0 hidden size-full object-cover md:block md:w-3/4' />
        </div>
